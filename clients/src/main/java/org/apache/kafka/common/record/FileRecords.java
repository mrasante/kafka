...
public class FileRecords extends AbstractRecords implements Closeable
{
  ...
  public TimestampAndOffset largestTimestampAfter(int startingPosition)
  {
    ...
    return new TimestampAndOffset(maxTimestamp, offsetOfMaxTimestamp, maybeLeaderEpoch(leaderEpochOfMaxTimestamp));
  }
  ...
  public static class TimestampAndOffset
  {
    ...
    public boolean equals(Object o)
    {
      ...
      return timestamp == that.timestamp && offset == that.offset && Objects.equals(leaderEpoch, that.leaderEpoch);
    }
